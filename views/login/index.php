  ...
  <div class="container-sign">
    <div class="card callout callout-info" style="width: 360px;">
      <div class="card-header" style="padding-bottom: 0px;">
        <img src="<?php echo base_url("/views/assets/img/logo_2.png"); ?>" style="max-width: 15rem;margin-top: 0px;margin-bottom: 0px;"><h1 style="margin-bottom: 0px;"></h1>
      ...
      <form method="post" <?php echo ajaxForm("/login/login", "form-signin") ?>>
        ...
        <div class="card-body">
          ...
          <div class="form-group"><label class="d-flex"><div>Senha</div>
            ...
            <span class="validation cdSenha text-danger small"></span>
          </div>
