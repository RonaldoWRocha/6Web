        ...
        <div class="card callout callout-info">
          <div class="card-body">
            <div class="form-group d-flex"><label class="checkbox">
              <input type="checkbox" name="lembreme" <?php if(isset($_COOKIE["date"])) { ?> checked <?php } ?>> <span class="check-mark"></span> Lembre-me</label>
            </div>
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-12">
                <div class="form-group">
                  <label>Ticket/Protocolo/Matricula</label>
                  <div class="input-group">
                    <input type="text" value="<?php if(isset($_COOKIE["tpm"])) { echo $_COOKIE["tpm"]; } ?>" name="tpm" class="form-control" placeholder="Ticket/Protocolo/Matricula">
                  </div>
                </div>
              </div>
                  ...
                  <div class="input-group">
                    <select type="text" name="idUsuario" class="form-control" placeholder="Nome" data-live-search="true">
                      ...
                      if(isset($_COOKIE["idUsuario"])) {
                        echo "<option value=\"".$_COOKIE["idUsuario"].";".$_COOKIE["matricula"].";".$_COOKIE["nome"]."\">".$_COOKIE["matricula"]." - ".$_COOKIE["nome"]."";
                      ...
                      foreach ($viewData['infousuario'] as $key => $value) {
                        ?>
                        <option value="<?= $value->idUsuario; ?>"><?= $value->idUsuario; ?> - <?= $value->nmCompleto; ?></option>
                        <?php
                      }
                      ?>
                    </select>
              ...
              <div class="col-12 col-md-6 col-lg-2">
                ...
                <input type="hidden" value="<?php if(isset($_COOKIE["matricula"])) { echo $_COOKIE["matricula"]; } ?>" name="matricula" class="form-control" placeholder="matricula">
