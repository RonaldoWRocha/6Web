...
<div class="callout">
  <h5 style="padding-top: 16px;margin-bottom: 0px;"><b><?= Session::get('registroSi')['nmUsuario']; ?>  | De:</b> <?= Session::get('registroSi')['dtInicial']; ?>  <b>até:</b> <?= Session::get('registroSi')['dtFinal']; ?> </b></h5>
</div>   
<div class="row">
<div class="col-12 mt-4">
    <div class="card callout callout-info">
	<form method="post" action="<?= base_url("/auditoria/mudarSetor/") ?>">
		<div class="col-12 col-md-6 col-lg-12">
		<div class="form-group">
		  <label>Setores do SI no Periodo:</label>
		  <div class="input-group">
			<select type="text" name="setSetor" class="form-control" placeholder="Nome" data-live-search="true">
			<?php if(Session::get('setSetor')['id'] != ''){ ?>
				<option value="<?= Session::get('setSetor')['id']; ?>;<?= Session::get('setSetor')['nome']; ?>"><?= Session::get('setSetor')['nome']; ?></option>
				<option disabled>----</option>
			<? } ?>
			<option value="">Todos</option>
			  <?php
			  foreach ($viewData['setoressi'] as $key => $value) {
				?>
		...
		<button type="submit" class="btn btn-primary">Mudar Setor</button>
	  </div>
  </form>
  </div>
  </div>
          ...
          <div class="col-12 col-lg-12">
            <div class="form-group">
              <table id="auditoria1" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php
                  if($viewData['rankingerrossi']){
                    foreach ($viewData['rankingerrossi'] as $key => $value) {
              ...
              <table id="auditoria" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th><font size=2>Auditor</font></th>
