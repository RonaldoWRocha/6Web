 ...
 * Função que retorna botão usado para deletar na requisição Ajax
 */
if (!function_exists('btnAjax')) {

    function btnAjax($controller, $value = null, $class = null, $nome = null)
    {
        return '<button class="ajaxBtnRequest ' . $class . '" data-controller="' . $controller . '" value="' . $value . '"><i class="btnAjaxForm fa "></i>' . $nome . '</button>';
    }
