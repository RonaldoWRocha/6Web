...
class Upload
{
	...
	/**
     * ADICIONA A EXTENSÃO TXT NAS PERMISSÕES DE UPLOAD
     * @return $this
     */
    public function txt()
    {
        $this->allowed = array_merge(['text/plain'],$this->allowed);

        return $this;
    }
	
	/**
     * ADICIONA A EXTENSÃO csv NAS PERMISSÕES DE UPLOAD
     * @return $this
     */
    public function csv()
    {
        $this->allowed = array_merge(['text/csv'],$this->allowed);
